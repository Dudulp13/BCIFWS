...
<body>
    <footer class="bg-dark"
        ...
        <div class="bg-transparent bg-opacity-33 p-4 rounded">
            <div class="glass-effect row justify-content-evenly">
                <!-- 1st Column for Contact Info -->
                <div class="col-lg-3 col-md-12 mb-4" id="reach">
                    <h4>Reach Us</h4>
                    <p>
                    ...
                    <p class="ps-5 ms-2">Iloilo 5002, Philippines</p>
                </div>

                <!-- 2nd Column for map -->
                <div class="col-lg-3 col-md-12 mb-4 me-3" id="reach">
                    <h4>Our Location</h4>
                    <p>
                        <span class="icon-circle">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12">
                    ...
                    <div>
                        <h3 class="mb-3">Help Us Advance the Kingdom of God</h3>
                    </div>
                    <p class="lead text-dark text-justify">
                        Your generosity has the power to transform lives within our community and beyond. By
                        contributing
                        to our mission, you are helping to spread love, hope, and essential resources to those in need.
                    ...
                    <p class="d-flex justify-content-start flex-wrap gap-3 mt-4">
                        <button class="btn btn-outline-info" type="button" data-bs-toggle="collapse"
                            data-bs-target="#gcashInfo" aria-expanded="false" aria-controls="gcashInfo">GCASH
                            Account</button>
                        <button class="btn btn-outline-info" type="button" data-bs-toggle="collapse"
                            data-bs-target="#bankInfo" aria-expanded="false" aria-controls="bankInfo">BANK
                            ACCOUNT</button>
                        <button class="btn btn-outline-info" type="button" data-bs-toggle="collapse"
                            data-bs-target="#wuInfo" aria-expanded="false" aria-controls="wuInfo">Western Union</button>
                    </p>
                    ...
                    <div class="row">
                        <div class="col-12 mt-2">
                            <div class="collapse multi-collapse" id="gcashInfo">
                                <div class="card text-dark card-body">09958398848 John Doe</div>
                            </div>
                        </div>
                        <div class="col-12 mt-2">
